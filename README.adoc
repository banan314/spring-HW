...
== Create an hello.Application class
Here you create an `hello.Application` class with the components:

`src/main/java/hello/hello.Application.java`
[source,java]
----
include::complete/src/main/java/hello/controllers.Application.java[]
----
