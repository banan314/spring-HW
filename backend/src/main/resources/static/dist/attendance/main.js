...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [_services_register_service__WEBPACK_IMPORTED_MODULE_14__["RegisterService"], _services_activity_service__WEBPACK_IMPORTED_MODULE_15__["ActivityService"], _services_user_service__WEBPACK_IMPORTED_MODULE_16__["UserService"], _services_log_in_service__WEBPACK_IMPORTED_MODULE_17__["LogInService"]],
...
var LogInService = /** @class */ (function () {
    ...
    LogInService.prototype.login = function (email, password) {
        var _this = this;
        var loginRequest = JSON.stringify({ email: email, password: password });
        ...
        var result = this.http.post('/backend/login', loginRequest, { headers: headers, observe: 'response' });
        result.subscribe(function (response) { return _this.mapResponse(response); });
        return result;
    };
