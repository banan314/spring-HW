...
public class ConsumerConfiguration {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, String> checkKafkaListenerContainerFactory() {
    ...
    private ConsumerFactory<String, String> consumerFactory(String groupId) {
        return new DefaultKafkaConsumerFactory<>(Map.of(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapAddress,
